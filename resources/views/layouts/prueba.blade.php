                                        ...
                                        <form class="form-horizontal form-label-left" data-parsley-validate="" id="demo-form2">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input class="form-control col-md-7 col-xs-12" id="first-name" required="required" type="text">
                                                    </input>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input class="form-control col-md-7 col-xs-12" id="last-name" name="last-name" required="required" type="text">
                                                    </input>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input class="form-control col-md-7 col-xs-12" id="middle-name" name="middle-name" type="text">
                                                    </input>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input class="date-picker form-control col-md-7 col-xs-12" id="birthday" required="required" type="text">
                                                    </input>
                                                </div>
                                            </div>
                                            <div class="ln_solid">
                            ...
                            <div class="col-md-6 col-xs-12">
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        You gave a rating of
                                        <span class="stars-count-existing">
                                            4
                                        </span>
                                        star(s)
                                    </div>
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form data-parsley-validate="" id="demo-form">
                                            <label for="fullname">
                                                Full Name * :
                                            </label>
                                            ...
                                            <input class="form-control" data-parsley-trigger="change" id="email" name="email" required="" type="email"/>
                                            <label>
                                                Gender *:
                                            </label>
                                            <p>
                                                M:
                                                <input checked="" class="flat" id="genderM" name="gender" required="" type="radio" value="M"/>
                                                F:
                                                <input class="flat" id="genderF" name="gender" type="radio" value="F"/>
                                            </p>
                                            <label>
                                                Hobbies (2 minimum):
                                            </label>
                                            <p style="padding: 5px;">
                                                <input class="flat" data-parsley-mincheck="2" id="hobby1" name="hobbies[]" required="" type="checkbox" value="ski"/>
                                                Skiing
                                                <br/>
                                                <input class="flat" id="hobby2" name="hobbies[]" type="checkbox" value="run"/>
                                                Running
                                                <br/>
                                                <input class="flat" id="hobby3" name="hobbies[]" type="checkbox" value="eat"/>
                                                Eating
                                                <br/>
                                                <input class="flat" id="hobby4" name="hobbies[]" type="checkbox" value="sleep"/>
                                                Sleeping
                                                <br/>
                                                <p>
                                                    <label for="heard">
                                                    ...
                                                    <select class="form-control" id="heard" required="">
                                                        <option value="">
                                                            Choose..
                                                        </option>
                                                        <option value="press">
                                                    ...
                                                    <textarea class="form-control" data-parsley-maxlength="100" data-parsley-minlength="20" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.." data-parsley-trigger="keyup" data-parsley-validation-threshold="10" id="message" name="message" required="required">
                                                    </textarea>
                                                    <br/>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <textarea class="form-control" placeholder='rows="3"' rows="3">
                                                    </textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <input class="form-control" type="password" value="passwordonetwo">
                                                    </input>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <input class="form-control col-md-10" id="autocomplete-custom-append" name="country" type="text"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <input class="tags form-control" id="tags_1" type="text" value="social, adverts, sales"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <div class="checkbox">
                                                        <label>
                                                            <input checked="checked" class="flat" type="checkbox">
                                                                Checked
                                                            </input>
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="checkbox">
                                                        <label>
                                                            <input class="flat" disabled="disabled" type="checkbox">
                                                                Disabled
                                                            </input>
                                                        </label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label>
                                                            <input checked="checked" class="flat" disabled="disabled" type="checkbox">
                                                                Disabled & checked
                                                            </input>
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label>
                                                            <input checked="" class="flat" name="iCheck" type="radio">
                                                                Checked
                                                            </input>
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label>
                                                            <input class="flat" name="iCheck" type="radio">
                                                                Unchecked
                                                            </input>
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label>
                                                            <input class="flat" disabled="disabled" name="iCheck" type="radio">
                                                                Disabled
                                                            </input>
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label>
                                                            <input checked="" class="flat" disabled="disabled" name="iCheck3" type="radio">
                                                                Disabled & Checked
                                                            </input>
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    ...
                                                    <div class="">
                                                        <label>
                                                            <input class="js-switch" disabled="disabled" type="checkbox"/>
                                                            Disabled
                                                        </label>
                                                    </div>
                                                    <div class="">
                                                        <label>
                                                            <input checked="checked" class="js-switch" disabled="disabled" type="checkbox"/>
                                                            Disabled Checked
                                                        </label>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="btn-toolbar editor" data-role="editor-toolbar" data-target="#editor-one">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu input-append">
                                                <input class="span2" data-edit="createLink" placeholder="URL" type="text"/>
                                        ...
                                        <div class="btn-group">
                                            <a class="btn" id="pictureBtn" title="Insert picture (or just drag & drop)">
                                    ...
                                    <div class="editor-wrapper" id="editor-one">
                                    </div>
                                    <textarea id="descr" name="descr" style="display:none;">
                                    </textarea>
                                    <br/>
                                    <div class="ln_solid">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <textarea class="resizable_textarea form-control" placeholder="This text area automatically resizes its height as you fill in more text courtesy of autosize-master it out...">
                                            </textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <input class="form-control col-md-7 col-xs-12" id="first-name2" required="required" type="text">
                                            </input>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <input class="form-control col-md-7 col-xs-12" id="last-name2" name="last-name" required="required" type="text">
                                            </input>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <form class="form-inline">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="ex3" placeholder=" " type="text">
                                        </input>
                                    </div>
                                    <div class="form-group">
                                        <label for="ex4">
                                        ...
                                        <input class="form-control" id="ex4" placeholder=" " type="email">
                                        </input>
                                    </div>
                                    <div class="checkbox">
                                        <label>
